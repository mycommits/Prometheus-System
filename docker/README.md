...
```bash
git clone https://github.com/mohammadhoseinchahardoli/Promatheus-System.git
cd Prometheus-System/docker

ADMIN_USER=admin ADMIN_PASSWORD=admin docker-compose up -d && docker-compose logs -f
```
...
![Host](./pics/Grafana_Docker_Host.png)
...
![Containers](./pics/Grafana_Docker_Containers.png)
...
Three alert groups have been setup within the [alert.rules](https://github.com/mohammadhoseinchahardoli/Promatheus-System/blob/master/docker/prometheus/alert.rules) configuration file:

* Monitoring services alerts [targets](https://github.com/mohammadhoseinchahardoli/Promatheus-System/blob/master/docker/prometheus/alert.rules#L2-L11)
* Docker Host alerts [host](https://github.com/mohammadhoseinchahardoli/Promatheus-System/blob/master/docker/prometheus/alert.rules#L13-L40)
* Docker Containers alerts [containers](https://github.com/mohammadhoseinchahardoli/Promatheus-System/blob/master/docker/prometheus/alert.rules#L42-L69)
...
The notification receivers can be configured in [alertmanager/config.yml](https://github.com/mohammadhoseinchahardoli/Promatheus-System/blob/master/docker/alertmanager/config.yml) file.
